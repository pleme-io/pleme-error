  ...
  internal = rec {
    ...
    crates = {
      ...
      "pleme-error" = rec {
        ...
        resolvedDefaultFeatures = [ "anyhow" "async-graphql" "axum" "context" "database" "default" "full" "graphql" "http" "http-errors" "logging" "redis" "serde" "serde_json" "serialization" "sqlx" "tracing" "web" ];
      };
      "polling" = rec {
        crateName = "polling";
        version = "3.11.0";
